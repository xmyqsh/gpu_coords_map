...
public:
    // TODO(ljm): move LOG_NUM_SUPER_BLOCKS and LOG_NUM_SUPER_BLOCKS into template to make it configurable
    static constexpr uint32_t LOG_NUM_MEM_BLOCKS = 5;
    static constexpr uint32_t LOG_NUM_SUPER_BLOCKS = 5;
    static constexpr uint32_t MEM_UNIT_WARP_MULTIPLES =
...
template <typename Key, typename Value, typename Hash, class Alloc>
Value unordered_map<Key, Value, Hash, Alloc>::Size() {
...
template <typename Key, typename Value, typename Hash, class Alloc>
Value unordered_map<Key, Value, Hash, Alloc>::BulkBuild(
...
template <typename Key, typename Value, typename Hash, class Alloc>
Value unordered_map<Key, Value, Hash, Alloc>::BulkBuild(Key* input_keys,
                                                    int num_keys) {
    CHECK_CUDA(cudaSetDevice(cuda_device_idx_));
...
template <typename Key, typename Value, typename Hash, class Alloc>
void unordered_map<Key, Value, Hash, Alloc>::CountElems(
